...
func isVariadicArgument(functionType reflect.Type, argIndex int) bool {
	if argIndex == functionType.NumIn()-1 && functionType.IsVariadic() {
		return functionType.In(argIndex).Kind() == reflect.Slice
	}
